...
public class ImdbTestFilms extends BasedSharedMethods {
    ...
    @Test
    public void imdbClickWildThenMotel2() {
...
// Scroll a klik přes JavaScript
    ...
    @Test
    public void imdbClickWildThenallienTom2() throws InterruptedException {
        driver.get("https://www.imdb.com/");
    ...
    @Test
    public void imdbClickWildThenallienTom22() throws InterruptedException {
        driver.get("https://www.imdb.com/");
        ...
        WebElement reeseLink = wait.until(ExpectedConditions.elementToBeClickable(
                By.xpath("//a[contains(text(),'Robert Zemeckis')]")
        ));
        reeseLink.click();

        // Počkej na načtení profilu herečky
        wait.until(ExpectedConditions.titleContains("Robert Zemeckis"));
        Assertions.assertTrue(driver.getTitle().contains("Robert Zemeckis"),
                "Na profil herečky nebyla načtena správná stránka.");
...
// Scroll a klik přes JavaScript
    ...
    @Test
    public void openFirstKnownForMovieSafely2() throws InterruptedException {
        String actressName = "Jennifer Aniston";
        driver.get("https://www.imdb.com/");
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(20));
